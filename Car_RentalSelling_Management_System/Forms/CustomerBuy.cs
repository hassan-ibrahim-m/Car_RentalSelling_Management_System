...
{
    public partial class CustomerBuyOld : Form
    {      
        User user = null;
        public Dictionary<string, string[]> dic;
        List<Cars> cars = null;

        public CustomerBuyOld(User user)
        {
            this.user = user;
        ...
        private void bt_submit_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Your transaction is Done "); 
        ...
        private void bt_apply_Click(object sender, EventArgs e)
        {
            ...
            string FuleType = db_FuelType.Text;
            ...
            if (db_Manufacturer.SelectedIndex == -1 || db_CarModel.SelectedIndex == -1
                ...
                || db_type.SelectedIndex == -1 || db_FuelType.SelectedIndex == -1
            ...
            else
            {
                ...
                cars = Connection.SelectCars_buy(Manufacturer, CarModel, MinYear, MaxYear, MinPrice, MaxPrice, Type, FuleType );
                Connection.CloseConnection();
                lv_buy.Items.Clear();
                foreach (Cars c in cars)
                {
                    ListViewItem lv = new ListViewItem(new string[] {c.Manufacturer, c.CarModel, c.FuelType, c.Year.ToString(), c.City, c.KM.ToString(), c.Rate.ToString(), c.Price.ToString(), c.PricePerDay.ToString(), c.Type});
                    lv_buy.Items.Add(lv);
                }
            }
        }
